...
export default defineConfig(({ mode }) => {
    ...
    return {
      server: {
        ...
        headers: {
          'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apis.google.com https://www.googletagmanager.com https://cdn.tailwindcss.com; connect-src 'self' https://auth.ghostnote.site https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://firestore.googleapis.com https://www.googleapis.com https://openrouter.ai; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://lh3.googleusercontent.com https://*.googleusercontent.com; frame-src 'self' https://auth.ghostnote.site https://ghostnoteai.firebaseapp.com https://*.firebaseapp.com;",
        },
      },
      build: {
        target: 'ES2022',
